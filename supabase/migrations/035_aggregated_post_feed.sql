...
-- Return the complete public post feed in one privacy-safe response. The
-- function deliberately omits author UUIDs and anonymous visitor identifiers;
-- callers receive only public profile fields and capability bits for themselves.
