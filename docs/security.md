...
- No private email or stable anonymous-visitor identifier in public API responses.
...
- Public post reads exclude `anonymous_visitor_id`; private member data is available only through admin-guarded RPCs.
